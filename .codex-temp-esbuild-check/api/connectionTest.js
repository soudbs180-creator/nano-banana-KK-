...
async function testModelsList(config) {
  ...
  try {
    ...
    const headers = nativeGemini ? buildGeminiHeaders(runtime.authMethod, config.apiKey, runtime.headerName, runtime.authorizationValueFormat) : buildProxyHeaders(runtime.authMethod, config.apiKey, runtime.headerName, void 0, runtime.authorizationValueFormat);
